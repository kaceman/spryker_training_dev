...
class AntelopesReader implements AntelopesReaderInterface
{
     ...
     */
    private AntelopeClientInterface $antelopeClient;
    /**
     * @var RestResourceBuilderInterface
     */
    private RestResourceBuilderInterface $restResourceBuilder;
    /**
     * @var AntelopesResourceMapperInterface
     */
    private AntelopesResourceMapperInterface $antelopesResourceMapper;
    ...
    private function addAntelopeNameSpecifiedError(RestResponseInterface $response)
    {
    ...
    private function addAntelopeNotFoundError(RestResponseInterface $response)
    {
        $restErrorTransfer = (new RestErrorMessageTransfer())
    ...
    private function createRestResourceFromAntelopeSearchData(array $antelopeData, RestRequestInterface $restRequest)
    {
